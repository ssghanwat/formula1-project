...
drivers_final_df.write.mode("overwrite").format("delta").saveAsTable("f1_proccessed.drivers")

# COMMAND ----------

# drivers_final_df.write.mode("overwrite").parquet(f"{proccessed_folder_path}/drivers")

# COMMAND ----------

# drivers_final_df.write.mode("overwrite").format("parquet").saveAsTable("f1_proccessed.drivers")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM f1_proccessed.drivers
